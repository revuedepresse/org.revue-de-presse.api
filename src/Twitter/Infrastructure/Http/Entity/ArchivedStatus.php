...
/**
 * @ORM\Entity(repositoryClass="App\Twitter\Infrastructure\Http\Repository\ArchivedStatusRepository")
 * @ORM\Table(
...
class ArchivedStatus implements StatusInterface
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Membership\Infrastructure\Entity\MembersList", inversedBy="userStreams", cascade={"persist"})
