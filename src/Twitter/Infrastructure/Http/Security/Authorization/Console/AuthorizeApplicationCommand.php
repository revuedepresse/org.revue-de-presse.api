...
namespace App\Twitter\Infrastructure\Http\Security\Authorization\Console;
...
use App\Twitter\Infrastructure\Http\Security\Authorization\InvalidPinCodeException;
