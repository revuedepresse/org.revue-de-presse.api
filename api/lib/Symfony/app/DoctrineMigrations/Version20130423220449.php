...
class Version20130423220449 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE weaving_perspective_ (per_id INT AUTO_INCREMENT NOT NULL, per_status INT DEFAULT NULL, per_type INT DEFAULT NULL, per_value LONGTEXT DEFAULT NULL, per_date_creation DATETIME DEFAULT NULL, per_date_update DATETIME DEFAULT NULL, per_description LONGTEXT DEFAULT NULL, INDEX query (per_value), PRIMARY KEY(per_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("DROP TABLE weaving_perspective_");
    }
}
