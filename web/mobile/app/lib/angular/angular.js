/**
 * @license AngularJS v1.2.12-build.local+sha.19ba651
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.12-build.local+sha.19ba651/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.12-build.local+sha.19ba651',    // all of these placeholder strings will be replaced by grunt's
