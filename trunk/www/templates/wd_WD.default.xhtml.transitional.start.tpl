...
<html xmlns='http://www.w3.org/1999/xhtml' xml:lang='fr'>
    <head>
        ...
        <script language='javascript' src='/js/jquery/jquery-1.5.js' type='text/javascript'></script>
        <script language='javascript' src='/js/jquery/jquery.focus.js' type='text/javascript'></script>
