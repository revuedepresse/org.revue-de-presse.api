...
class Alpha implements Particle
{
    ...
    */
    private function spawnDefaultContext( $conditions, $quantities )
    {
		...
		if ( is_null( $this->{CONDITION_WHAREHOUSE} ) )
		
			$this->{CONDITION_WHAREHOUSE} = DIR_PHOTOGRAPHS;
		...
		$warehouse = &$this->{CONDITION_WHAREHOUSE};
    ...
    */
    public static function __callStatic($name, $arguments)
    {
        ...
        // check if a method exist elsewhere
        else if (method_exists(AGENT_CONTEXT, "_".$name));

            // call a user function
            return call_user_func_array(array(AGENT_CONTEXT, "_".$name), $arguments);        
    }
    ...
    */
    public function &getCondition($name)
    {
        ...
        if (
            ...
            // initialize a condition from the name argument
