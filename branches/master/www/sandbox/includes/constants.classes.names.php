...
assignConstant( 'CLASS_BOOK', 'Book' );
...
assignConstant( 'CLASS_DATA_MINER', 'Data_Miner' );
...
assignConstant( 'CLASS_FILE', 'File' );
...
assignConstant( 'CLASS_FEED', 'Feed' );
...
assignConstant( 'CLASS_INTROSPECTOR', 'Introspector' );
...
assignConstant( 'CLASS_PUBLICATION', 'Publication' );
...
assignConstant( 'CLASS_SYNDICATION', 'Syndication' );
...
assignConstant( 'CLASS_TOKEN_STREAM', 'Token_Stream' );
