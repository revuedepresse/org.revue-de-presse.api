...
if ( $verbose_mode ) echo $element_html->export( FORMAT_TYPE_XML, FALSE );

$class_dumper::log( __METHOD__, array(
	'$element_html', $element_html,
	'$element_html->{PROPERTY_ATTRIBUTES}', $element_html->{PROPERTY_ATTRIBUTES},
	'$element_html->{PROPERTY_DOM_DOCUMENT}', $element_html->{PROPERTY_DOM_DOCUMENT},		
	'$element_html->{PROPERTY_DOM_ELEMENT}', $element_html->{PROPERTY_DOM_ELEMENT},
	'( string ) $element_html;', ( string ) $element_html,
