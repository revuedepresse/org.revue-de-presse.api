...
list( $service_amazon, $service_type_default ) = $class_api::checkService(
	$service_type_amazon
);
...
$class_dumper::log(
	__METHOD__,
	array(
		'[service amazon]', $service_amazon,
		'[service type amazon]', $service_type_amazon,
...
$store = $class_api::initializeStore(
	$service_amazon, $store_parent_type_merchant_platform
);
