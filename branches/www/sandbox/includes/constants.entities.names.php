...
assignConstant( 'ENTITY_BOOK', 'book' );
...
assignConstant( 'ENTITY_CONSUMER', 'consumer' );
...
assignConstant( 'ENTITY_DATA_MINER', 'data_miner' );
assignConstant( 'ENTITY_DB', 'db' );
assignConstant( 'ENTITY_DELIMITER', 'delimiter' );
...
assignConstant( 'ENTITY_DIRECTORY_ROOT', 'root_directory' );
...
assignConstant( 'ENTITY_FAVORITE', 'favorite' );
assignConstant( 'ENTITY_FEED', 'feed' );
...
assignConstant( 'ENTITY_FILE', 'file' );
...
assignConstant( 'ENTITY_INITIALIZATION', 'initialization' );
...
assignConstant( 'ENTITY_INTROSPECTOR', 'introspector' );
assignConstant( 'ENTITY_JQUERY4PHP', 'jquery4php' );
assignConstant( 'ENTITY_KEY', 'key' );
...
assignConstant( 'ENTITY_MAPPING', 'mapping' );
assignConstant( 'ENTITY_MASHUP', 'mashup' );
...
assignConstant( 'ENTITY_MEMORY_CACHE', 'memory_cache' );
assignConstant( 'ENTITY_MENU', 'menu' );
assignConstant( 'ENTITY_MERCHANT_PLATFORM', 'merchant_platform' );
...
assignConstant( 'ENTITY_PROTOCOL', 'protocol' );
assignConstant( 'ENTITY_PROVER', 'prover' );
assignConstant( 'ENTITY_PUBLICATION', 'publication' );
...
assignConstant( 'ENTITY_RECORD', 'record' );
assignConstant( 'ENTITY_RENDER', 'render' );
assignConstant( 'ENTITY_RESOURCE', 'resource' );
assignConstant( 'ENTITY_RIVER', 'river' );
...
assignConstant( 'ENTITY_SYNDICATION', 'syndication' );
assignConstant( 'ENTITY_SYNTAX', 'syntax' );
...
assignConstant( 'ENTITY_TIMELINE', 'timeline' );
assignConstant( 'ENTITY_TITLE', 'title' );
assignConstant( 'ENTITY_TOKEN', 'token' );
assignConstant( 'ENTITY_TOKEN_STREAM', 'token_stream' );
