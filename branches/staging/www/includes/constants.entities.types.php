...
assignConstant( 'AGGREGATION_TYPE_FUNCTION_CALLS*', 'function_calls' );

// API types

assignConstant( 'API_TYPE_AMAZON', 'amazon' );
assignConstant( 'API_TYPE_GITHUB*', 'github' );
...
assignConstant( 'JSON_TYPE_FACEBOOK_HOME*', 0 );
assignConstant( 'JSON_TYPE_FACEBOOK_FEED', 1 );
...
assignConstant( 'RENDER_TYPE_BLOCK', 'block' );
assignConstant( 'RENDER_TYPE_SIGNAL', 'signal' );
assignConstant( 'RENDER_TYPE_SUBSEQUENCE*', 'subsequence' );
assignConstant( 'RENDER_TYPE_SUBSTREAM', 'substream' );
assignConstant( 'RENDER_TYPE_TOKEN', 'token' );
...
assignConstant( 'SQL_CLAUSE_ORDER_BY_TYPE_ASC', 'ASC' );
assignConstant( 'SQL_CLAUSE_ORDER_BY_TYPE_DESC', 'DESC' );
