		...
		if ( ! isset( $context ) )
		{
			...
			switch ( $route->type )
			{
				...
				case ROUTE_TYPE_AFFORDANCE:
					...
					$path_configuration_folder = PATH_CONFIG;

					// set the configuration form file name
					$form_configuration_file =
						$path_configuration_folder .
						CHARACTER_SLASH . PREFIX_FORM.
						$affordance.
						EXTENSION_YAML
					;
					...
					else
					{
						...
						if (
							...
							$content_not_found = file_get_contents(
...
* support :: routing ::
*
* Revise access to 404 not found page
*
* method affected ::
* 
* INTERCEPTOR :: route
...
*
* Use proper syntax to load object of type Agent
* 
