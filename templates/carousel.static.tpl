...
<html xmlns='http://www.w3.org/1999/xhtml' xml:lang='fr'>
    ...
    <body>
        ...
        {literal}
            ...
            'photographs/meurin.vincent/carte-promo-72-dpi.jpg',
            'article1.html',
            'Item 1 Title',
            'Item 1 Description'
            );
            mySlideData[countArticle++] = new Array(
            'photographs/meurin.vincent/pola-5-53pm.jpg',
            'article2.html',
            'Item 2 Title',
            'Item 2 Description'
            );
            mySlideData[countArticle++] = new Array(
            'photographs/meurin.vincent/pola-kama-sutra.jpg',
            'article2.html',
            'Item 3 Title',
            'Item 3 Description'
            );
            mySlideData[countArticle++] = new Array(
            'photographs/meurin.vincent/pola-even-after-all.jpg',
            'article2.html',
            'Item 4 Title',
            'Item 4 Description'
            );
            mySlideData[countArticle++] = new Array(
            'photographs/meurin.vincent/pola-social-club.jpg',
            'article2.html',
            'Item 5 Title',
            'Item 5 Description'
            );
            mySlideData[countArticle++] = new Array(
            'photographs/meurin.vincent/pola-sorry-angel.jpg',
            'article2.html',
            'Item 6 Title',
            'Item 6 Description'
            );
            mySlideData[countArticle++] = new Array(
            'photographs/meurin.vincent/pola-take-me-to-the-river.jpg',
            'article2.html',
            'Item 7 Title',
            'Item 7 Description'
            );            
